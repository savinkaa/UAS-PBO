...
class Game:
    ...
    def run_game_loop(self, level_speed):
        ...
        while not is_game_over:
            ...
            if player_character.detection_collision(enemy_0) or\
                (level_speed > 2 and player_character.detection_collision(enemy_1)) or \
                (level_speed > 4 and player_character.detection_collision(enemy_2)):
                is_game_over = True
                did_win = False
